...
namespace Nyangbingo.Data
{
    ...
    public sealed class MineralTierDefinition : ScriptableObject
    {
        ...
        [Range(1, 3)][SerializeField] private int hardness = 1;
        [SerializeField] private bool breakableByClawTierOne = true;
        [SerializeField] private bool breakableByClawTierTwo = true;
        [SerializeField] private bool breakableByClawTierThree = true;
        ...
        [TextArea][SerializeField] private string hardnessDescription;
        ...
        public bool BreakableByClawTierOne => breakableByClawTierOne;
        public bool BreakableByClawTierTwo => breakableByClawTierTwo;
        public bool BreakableByClawTierThree => breakableByClawTierThree;
        ...
        public string HardnessDescription => hardnessDescription;
        ...
        public bool CanBreakWithClawTier(int clawTier) => clawTier switch
        {
            1 => breakableByClawTierOne,
            2 => breakableByClawTierTwo,
            3 => breakableByClawTierThree,
            _ => false
        };
